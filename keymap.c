...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    // |---------------------------------------------------------------|
    // |CapsL |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return  |PgU|
    // |---------------------------------------------------------------|
    ...
    [_BL] = LAYOUT(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,        KC_SPC,         KC_SPC,         KC_SPC,         KC_RCTL,XXXX   ,MO(_FL),KC_LEFT,KC_DOWN,KC_RGHT
    ),
    ...
    [_FL] = LAYOUT(
        ...
        ____,   ____,   ____,   ____,   ____,   ____,   ____,   ____,   ____,   ____,   ____,   ____,   ____,           ____,   KC_END,
